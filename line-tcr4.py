...
cl = LINETCR.LINE()
cl.login(token='ElEKJzcRMdaWXHv4aP50.SAl+VzXlpKOr1+hGO1g2ya.I5a+jwK3LP+gvZfy+c/XFQ8/2WKfFs655gdrZ3op7DQ=')
cl.loginResult()
...
admin=["u08e9cd731858f70f3c2d918cf16484bd","u5a1a1b3e39e6b3d7df4a8a08787a0bc1"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					...
					kk.sendText(msg.to,"Siap Bos 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
#-----------------------------------------------
            elif "Mark say " in msg.text:
				if msg.from_ in admin:
					bctxt = msg.text.replace("Mark say ","")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Mark 42 􀜁􀅔Har Har􏿿")
					kk.sendText(msg.to,"Mark 43 􀜁􀅔Har Har􏿿")
#-----------------------------------------------
